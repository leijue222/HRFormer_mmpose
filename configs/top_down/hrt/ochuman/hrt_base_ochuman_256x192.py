...
model = dict(
    type='TopDown',
    pretrained='/media/ming-t/F83438063437C702/project/HRFormer-main/pose/hrt_base_coco_256x192.pth', # Set the path to pretrained backbone here
    backbone=dict(
        type='HRT',
        in_channels=3,
        norm_cfg=norm_cfg,
...
# data_root = "/media/ming-t/F83438063437C702/datasets/coco" # Set the data path here
data_root = "/media/ming-t/F83438063437C702/datasets/OCHuman" # Set the data path here
data_cfg = dict(
    image_size=[192, 256],
    heatmap_size=[48, 64],
